 ...
 */
final class Version20240616204657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cryptocurrency (id INT AUTO_INCREMENT NOT NULL, id_wallet_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, abreviation VARCHAR(255) NOT NULL, INDEX IDX_CC62CFADF1109CD4 (id_wallet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE wallet (id INT AUTO_INCREMENT NOT NULL, id_user_id INT DEFAULT NULL, quantity_crypto INT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_7C68921F79F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE wallet_crypto (id INT AUTO_INCREMENT NOT NULL, wallet_id_id INT DEFAULT NULL, crypto_id_id INT DEFAULT NULL, solde NUMERIC(10, 0) NOT NULL, activation TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_D888B7C1F43F82D (wallet_id_id), UNIQUE INDEX UNIQ_D888B7C169F28E2C (crypto_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
